-- Pasthetic all-in-one generated from local split modules.
-- Do not edit this file by hand; regenerate it with tools/build_allinone.ps1.
local __pasthetic_allinone = true
local __pasthetic_disable_allinone_update = rawget(_G, '__pasthetic_allinone_bootstrap') == true
local __pasthetic_allinone_version = "2026.05.17-10"
local __pasthetic_allinone_target_path = ".\\Pasthetic_allinone.lua"
